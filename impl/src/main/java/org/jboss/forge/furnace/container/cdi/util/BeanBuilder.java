 ...
 * <p/>
 * <p>
 * The builder can read from an {@link AnnotatedType} and have any attribute modified. This class is not thread-safe,
 * but the bean created by calling {@link #create()} is.
 * </p>
 * <p/>
 * <p>
...
public class BeanBuilder<T>
{
    ...
    * 
    * @param beanManager the bean manager to use for creating injection targets and determining if annotations are
    *           qualifiers, scopes or stereotypes.
    */
    ...
    * 
    * @param alternative <code>true</code> if the created bean should be an alternative, otherwise <code>false</code>
    */
    ...
    * 
    * @param beanLifecycle the {@link ContextualLifecycle} to use for bean creation.
    */
    ...
    * 
    * @param name the name of the bean to use or <code>null</code> if the bean should have no name
    */
    ...
    * 
    * @param passivationCapable <code>true</code> if the created bean should be passivation capable, otherwise
    *           <code>false</code>
    */
